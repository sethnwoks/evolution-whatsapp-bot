...
Render will automatically detect render.yaml and spin up all three services.
...
Open the Evolution Manager (URL provided by Render).
Navigate to Instance > QRCode.
